...
final class TudoEmUmController extends TemplateLayoutController{
  ...
  public function carregar_pagina($redirecionar = false){
    ...
    $valores['tudo_em_um']['lista_de_pessoas'] = $this->mostrar_pessoas();

    return Inertia::render('tudo_em_um/tudo_em_um', $valores);
  }
  ...
  public function mostrar_pessoas_ajax($mensagem_de_sucesso = ""){
    ...
    $retorno['lista_de_pessoas'] = $this->mostrar_pessoas($metodo);
