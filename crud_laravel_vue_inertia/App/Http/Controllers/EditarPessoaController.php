...
final class EditarPessoaController extends TemplateLayoutController{
  ...
  public function carregar_pagina($redirecionar_com_id = false){
    ...
    $valores['editar_pessoa']['mensagem'] = '';
    $valores['editar_pessoa']['tipo_de_mensagem'] = 'sucesso';
    $valores['editar_pessoa']['id_valido'] = true;
    $valores['editar_pessoa']['id_da_pessoa'] = '';
    $valores['editar_pessoa']['nome'] = '';
    $valores['editar_pessoa']['sobrenome'] = '';
    $valores['editar_pessoa']['cpf'] = '';
    $valores['editar_pessoa']['data_de_nascimento'] = '';
    $valores['editar_pessoa']['sexos'] = $pessoa->enum_sexo();
    $valores['editar_pessoa']['sexo'] = '';
    $valores['editar_pessoa']['setores'] = $array_setores;
    $valores['editar_pessoa']['id_do_setor'] = '';
    $valores['editar_pessoa']['email'] = '';
    $valores['editar_pessoa']['telefone_fixo'] = '';
    $valores['editar_pessoa']['telefone_movel'] = '';
    $valores['editar_pessoa']['telefone_estrangeiro'] = '';
    ...
    if(!is_numeric($id_da_pessoa) or $id_da_pessoa <= 0 or floor($id_da_pessoa) != $id_da_pessoa){
      ...
      $valores['editar_pessoa']['mensagem'] = $mensagem;
      $valores['editar_pessoa']['tipo_de_mensagem'] = 'falha';
      $valores['editar_pessoa']['id_valido'] = false;
    }else{
      ...
      if(isset($array_resultado['mensagem_do_model'])){
        $valores['editar_pessoa']['mensagem'] = $array_resultado['mensagem_do_model'];
        $valores['editar_pessoa']['tipo_de_mensagem'] = 'falha';
        $valores['editar_pessoa']['id_valido'] = false;
      }else{
        ...
        $valores['editar_pessoa']['id_da_pessoa'] = $id;

        $nome = $pessoa->get_nome();
        $valores['editar_pessoa']['nome'] = $nome;

        $sobrenome = $pessoa->get_sobrenome();
        $valores['editar_pessoa']['sobrenome'] = $sobrenome;

        $cpf = $pessoa->get_cpf();
        $valores['editar_pessoa']['cpf'] = $cpf;

        $data_de_nascimento = $pessoa->get_data_de_nascimento();
        $data_convertida = $this->converter_para_data_do_html($data_de_nascimento);
        $valores['editar_pessoa']['data_de_nascimento'] = $data_convertida;

        $sexo = $pessoa->get_sexo();
        $valores['editar_pessoa']['sexo'] = $sexo;

        $id_do_setor = $pessoa->get_setor()->get_pk_setor();
        $valores['editar_pessoa']['id_do_setor'] = $id_do_setor;

        $email = $pessoa->get_email();
        $valores['editar_pessoa']['email'] = $email;

        $telefone_fixo = $pessoa->get_telefone_fixo();
        $valores['editar_pessoa']['telefone_fixo'] = $telefone_fixo;

        $telefone_movel = $pessoa->get_telefone_movel();
        $valores['editar_pessoa']['telefone_movel'] = $telefone_movel;

        $telefone_estrangeiro = $pessoa->get_telefone_estrangeiro();
        $valores['editar_pessoa']['telefone_estrangeiro'] = $telefone_estrangeiro;
      }
    }
    ...
    if($sessao->has('backup_do_formulario_da_pagina_editar_pessoa')){
      ...
      $valores['editar_pessoa']['nome'] = $backup['nome'];
      $valores['editar_pessoa']['sobrenome'] = $backup['sobrenome'];
      $valores['editar_pessoa']['cpf'] = $backup['cpf'];
      $valores['editar_pessoa']['data_de_nascimento'] = $backup['data_de_nascimento'];
      $valores['editar_pessoa']['sexo'] = $backup['sexo'];
      $valores['editar_pessoa']['id_do_setor'] = $backup['id_do_setor'];
      $valores['editar_pessoa']['email'] = $backup['email'];
      $valores['editar_pessoa']['telefone_fixo'] = $backup['telefone_fixo'];
      $valores['editar_pessoa']['telefone_movel'] = $backup['telefone_movel'];
      $valores['editar_pessoa']['telefone_estrangeiro'] = $backup['telefone_estrangeiro'];
    ...
    if($sessao->has('mensagem_da_pagina_editar_pessoa')){
      $valores['editar_pessoa']['mensagem'] = $sessao->get('mensagem_da_pagina_editar_pessoa');
      $valores['editar_pessoa']['tipo_de_mensagem'] = $sessao->get('tipo_de_mensagem_da_pagina_editar_pessoa');
      $sessao->forget('mensagem_da_pagina_editar_pessoa');
      $sessao->forget('tipo_de_mensagem_da_pagina_editar_pessoa');
      $sessao->save();
    }

    return Inertia::render('editar_pessoa/editar_pessoa', $valores);
  }
  ...
  public function editar(){
    ...
    $array_resultado = $editar_pessoa_model->verificar_disponibilidade_de_nome_completo($nome_completo, $id_da_pessoa);
    if(isset($array_resultado['mensagem_do_model'])){
      $mensagem = 'A pessoa não foi editada.';
      $mensagem .= ' '.$array_resultado['mensagem_do_model'];
      $sessao->put('mensagem_da_pagina_editar_pessoa', $mensagem);
