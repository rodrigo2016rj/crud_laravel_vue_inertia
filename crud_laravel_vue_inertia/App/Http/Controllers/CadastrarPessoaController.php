...
final class CadastrarPessoaController extends TemplateLayoutController{
  ...
  public function carregar_pagina($redirecionar = false){
    ...
    $valores['cadastrar_pessoa']['mensagem'] = '';
    $valores['cadastrar_pessoa']['tipo_de_mensagem'] = 'sucesso';
    $valores['cadastrar_pessoa']['nome'] = '';
    $valores['cadastrar_pessoa']['sobrenome'] = '';
    $valores['cadastrar_pessoa']['cpf'] = '';
    $valores['cadastrar_pessoa']['data_de_nascimento'] = '';
    $valores['cadastrar_pessoa']['sexos'] = $pessoa->enum_sexo();
    $valores['cadastrar_pessoa']['sexo'] = '';
    $valores['cadastrar_pessoa']['setores'] = $array_setores;
    $valores['cadastrar_pessoa']['id_do_setor'] = '';
    $valores['cadastrar_pessoa']['email'] = '';
    $valores['cadastrar_pessoa']['telefone_fixo'] = '';
    $valores['cadastrar_pessoa']['telefone_movel'] = '';
    $valores['cadastrar_pessoa']['telefone_estrangeiro'] = '';
    ...
    if($sessao->has('backup_do_formulario_da_pagina_cadastrar_pessoa')){
      ...
      $valores['cadastrar_pessoa']['nome'] = $backup['nome'];
      $valores['cadastrar_pessoa']['sobrenome'] = $backup['sobrenome'];
      $valores['cadastrar_pessoa']['cpf'] = $backup['cpf'];
      $valores['cadastrar_pessoa']['data_de_nascimento'] = $backup['data_de_nascimento'];
      $valores['cadastrar_pessoa']['sexo'] = $backup['sexo'];
      $valores['cadastrar_pessoa']['id_do_setor'] = $backup['id_do_setor'];
      $valores['cadastrar_pessoa']['email'] = $backup['email'];
      $valores['cadastrar_pessoa']['telefone_fixo'] = $backup['telefone_fixo'];
      $valores['cadastrar_pessoa']['telefone_movel'] = $backup['telefone_movel'];
      $valores['cadastrar_pessoa']['telefone_estrangeiro'] = $backup['telefone_estrangeiro'];
    ...
    if($sessao->has('mensagem_da_pagina_cadastrar_pessoa')){
      $valores['cadastrar_pessoa']['mensagem'] = $sessao->get('mensagem_da_pagina_cadastrar_pessoa');
      $valores['cadastrar_pessoa']['tipo_de_mensagem'] = $sessao->get('tipo_de_mensagem_da_pagina_cadastrar_pessoa');
      $sessao->forget('mensagem_da_pagina_cadastrar_pessoa');
      $sessao->forget('tipo_de_mensagem_da_pagina_cadastrar_pessoa');
      $sessao->save();
    }

    return Inertia::render('cadastrar_pessoa/cadastrar_pessoa', $valores);
  }
