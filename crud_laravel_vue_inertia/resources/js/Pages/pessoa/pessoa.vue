    ...
    <template #conteudo>
      <div id="div_pagina_pessoa">
        <h2 id="h2_titulo_da_pagina">
          <span v-if="pessoa.id_valido">{{pessoa.nome_completo_da_pessoa}}</span>
          <span v-else>Pessoa</span>
        </h2>
        <div v-if="pessoa.mensagem" id="div_mensagem">
          <span id="span_mensagem" :class="'mensagem_de_'+pessoa.tipo_de_mensagem">{{pessoa.mensagem}}</span>
        </div>
        <template v-if="pessoa.id_valido">
          <div id="div_opcoes_da_pagina">
            ...
            <div id="div_lista_de_opcoes_da_pagina">
              <a id="link_editar_pessoa" class="opcao_da_pagina" 
                 :href="'/editar_pessoa?id='+pessoa.id_da_pessoa">Editar Pessoa</a>
              <a id="link_excluir_pessoa" class="opcao_da_pagina" 
                 :href="'/excluir_pessoa?id='+pessoa.id_da_pessoa">Excluir Pessoa</a>
            </div>
          </div>
            ...
            <div id="div_informacoes_da_pessoa">
              <div id="div_local_do_nome_completo" class="informacao_da_pessoa">
                ...
                <div id="div_nome_completo" class="local_da_parte_especifica_da_informacao">
                  <span id="span_nome_completo" 
                        class="parte_especifica_da_informacao">{{pessoa.nome_completo_da_pessoa}}</span>
                </div>
              </div>
              <div id="div_local_do_cpf" class="informacao_da_pessoa">
                ...
                <div id="div_cpf" class="local_da_parte_especifica_da_informacao">
                  <span id="span_cpf" class="parte_especifica_da_informacao">{{pessoa.cpf_da_pessoa}}</span>
                </div>
              </div>
              <div id="div_local_da_data_de_nascimento" class="informacao_da_pessoa">
                ...
                <div id="div_data_de_nascimento" class="local_da_parte_especifica_da_informacao">
                  <span id="span_data_de_nascimento" class="parte_especifica_da_informacao">{{pessoa.data_de_nascimento_da_pessoa}}</span>
                </div>
              </div>
              <div id="div_local_da_idade" class="informacao_da_pessoa">
                ...
                <div id="div_idade" class="local_da_parte_especifica_da_informacao">
                  <span id="span_idade" class="parte_especifica_da_informacao">{{pessoa.idade_da_pessoa}}</span>
                </div>
              </div>
              <div id="div_local_do_sexo" class="informacao_da_pessoa">
                ...
                <div id="div_sexo" class="local_da_parte_especifica_da_informacao">
                  <span id="span_sexo" :class="['parte_especifica_da_informacao', pessoa.sexo_classe_css]">{{pessoa.sexo_da_pessoa}}</span>
                </div>
              </div>
              <div id="div_local_do_setor" class="informacao_da_pessoa">
                ...
                <div id="div_setor" class="local_da_parte_especifica_da_informacao">
                  <span id="span_setor" class="parte_especifica_da_informacao">{{pessoa.setor_da_pessoa}}</span>
                </div>
              </div>
              <div id="div_local_do_email" class="informacao_da_pessoa">
                ...
                <div id="div_email" class="local_da_parte_especifica_da_informacao">
                  <span id="span_email" class="parte_especifica_da_informacao">{{pessoa.email_da_pessoa}}</span>
                </div>
              </div>
              <div id="div_local_do_telefone_fixo" class="informacao_da_pessoa">
                ...
                <div v-if="pessoa.telefone_fixo_da_pessoa" id="div_telefone_fixo" 
                     class="local_da_parte_especifica_da_informacao">
                  <span id="span_telefone_fixo" class="parte_especifica_da_informacao">{{pessoa.telefone_fixo_da_pessoa}}</span>
                </div>
              ...
              <div id="div_local_do_telefone_movel" class="informacao_da_pessoa">
                ...
                <div v-if="pessoa.telefone_movel_da_pessoa" id="div_telefone_movel" 
                     class="local_da_parte_especifica_da_informacao">
                  <span id="span_telefone_movel" class="parte_especifica_da_informacao">{{pessoa.telefone_movel_da_pessoa}}</span>
                </div>
              ...
              <div id="div_local_do_telefone_estrangeiro" class="informacao_da_pessoa">
                ...
                <div v-if="pessoa.telefone_estrangeiro_da_pessoa" id="div_telefone_estrangeiro" 
                     class="local_da_parte_especifica_da_informacao">
                  <span id="span_telefone_estrangeiro" class="parte_especifica_da_informacao">{{pessoa.telefone_estrangeiro_da_pessoa}}</span>
                </div>
