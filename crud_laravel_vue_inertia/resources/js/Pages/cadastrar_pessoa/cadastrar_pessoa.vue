  ...
  export default{
    ...
    data(){
      return{
        ...
        vue_cadastrar_pessoa: this.cadastrar_pessoa,
    ...
    created(){
      ...
      for(let i = 0; i < this.vue_cadastrar_pessoa.setores.length; i++){
        if(this.vue_cadastrar_pessoa.setores[i].id == this.vue_cadastrar_pessoa.id_do_setor){
    ...
    methods: {
      aplicar_mascara_para_o_campo_cpf(evento){
        ...
        this.ultimo_valor_campo_cpf = campo_cpf.value;
        this.vue_cadastrar_pessoa.cpf = campo_cpf.value;
      },
      ...
      aplicar_mascara_para_o_campo_telefone_fixo(evento){
        ...
        this.vue_cadastrar_pessoa.telefone_fixo = campo_telefone_fixo.value;
      },
      aplicar_mascara_para_o_campo_telefone_movel(evento){
        ...
        this.vue_cadastrar_pessoa.telefone_movel = campo_telefone_movel.value;
      },
      remover_popups(){
  ...
  <TemplateLayout :template_layout="vue_template_layout">
    <template #conteudo>
      <div id="div_pagina_cadastrar_pessoa">
        ...
        <div id="div_mensagem" v-if="vue_cadastrar_pessoa.mensagem">
          <span id="span_mensagem" :class="['mensagem_de_'+vue_cadastrar_pessoa.tipo_de_mensagem]">{{vue_cadastrar_pessoa.mensagem}}</span>
        </div>
        <form id="form_cadastrar" method="post" action="/cadastrar_pessoa/cadastrar">
          ...
          <div id="div_cadastrar_nome">
            ...
            <div id="div_campo_nome">
              <input type="text" id="campo_nome" name="nome" v-model="vue_cadastrar_pessoa.nome" autocomplete="off"/>
            </div>
          </div>
          <div id="div_cadastrar_sobrenome">
            ...
            <div id="div_campo_sobrenome">
              <input type="text" id="campo_sobrenome" name="sobrenome" v-model="vue_cadastrar_pessoa.sobrenome" 
                     autocomplete="off"/>
            </div>
          </div>
          <div id="div_cadastrar_cpf">
            ...
            <div id="div_campo_cpf">
              <input type="text" id="campo_cpf" name="cpf" @keyup="aplicar_mascara_para_o_campo_cpf" 
                     v-model="vue_cadastrar_pessoa.cpf" autocomplete="off"/>
            </div>
          </div>
          <div id="div_cadastrar_data_de_nascimento">
            ...
            <div id="div_campo_data_de_nascimento">
              <input type="text" id="campo_data_de_nascimento" name="data_de_nascimento" 
                     v-model="vue_cadastrar_pessoa.data_de_nascimento" @mouseenter="colocar_borda_hover_no_campo" 
          ...
          <div id="div_cadastrar_sexo">
            ...
            <div id="div_lista_de_sexos">
              <template v-for="(valor, chave) in vue_cadastrar_pessoa.sexos">
                <label class="item_da_lista_de_sexos">
                  <input type="radio" name="sexo" :value="chave" v-model="vue_cadastrar_pessoa.sexo" autocomplete="off"/>
                  <span>&nbsp;</span>
                  <span>{{valor}}</span>
                </label>
              </template>
          ...
          <div id="div_cadastrar_setor">
            ...
            <div id="div_caixa_de_selecao_setor">
              ...
              <div id="div_descricoes_dos_setores" class="tag_oculta">
                <template v-for="(setor, chave) in vue_cadastrar_pessoa.setores">
          ...
          <div id="div_cadastrar_email">
            ...
            <div id="div_campo_email">
              <input type="text" id="campo_email" name="email" v-model="vue_cadastrar_pessoa.email" autocomplete="off"/>
            </div>
          </div>
          <div id="div_cadastrar_telefone_fixo">
            ...
            <div id="div_campo_telefone_fixo">
              <input type="text" id="campo_telefone_fixo" name="telefone_fixo" v-model="vue_cadastrar_pessoa.telefone_fixo" 
          ...
          <div id="div_cadastrar_telefone_movel">
            ...
            <div id="div_campo_telefone_movel">
              <input type="text" id="campo_telefone_movel" name="telefone_movel" v-model="vue_cadastrar_pessoa.telefone_movel" 
          ...
          <div id="div_cadastrar_telefone_estrangeiro">
            ...
            <div id="div_campo_telefone_estrangeiro">
              <input type="text" id="campo_telefone_estrangeiro" name="telefone_estrangeiro" 
                     v-model="vue_cadastrar_pessoa.telefone_estrangeiro" autocomplete="off"/>
            </div>
          </div>
